...
//        petAdapter.setOnItemClickListener {
//            findNavController().navigate(R.id.action_tabAll_to_fragmentDetailPet)
//            childFragmentManager.beginTransaction().replace(R.id.tabAll, FragmentDetailPet())
//                .commit()
//        }
    }
}